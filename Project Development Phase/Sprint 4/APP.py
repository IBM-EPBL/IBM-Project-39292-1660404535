...
API_KEY = "Zk63BFxRj2UK_ZShWEW2MesieH3vnLO1Efv2BKyniHgX"
...
def upload():
    if request.method == "POST":
        ...
        response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/4626247a-30b9-4234-aaf5-97b75bb4e1b5/predictions?version=2022-11-17', json=payload_scoring,headers={'Authorization': 'Bearer ' + mltoken})
